        ...
        <footer className="bg-white border-t mt-5 dark:bg-gray-900">
            <div className="mx-auto w-full p-5 ">
                <div className="grid grid-cols-1 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                    <div>
                        ...
                        <ul className="text-gray-500 dark:text-gray-400 font-medium">
                            ...
                            <p>B & K Export Trade Co. epitomizes the essence of men's fashion, blending sophistication with timeless style. Each piece narrates a tale of classic adventures and urban explorations, seamlessly merging the realms of reality and dreams.</p>
                            <p className='mt-2 '> <b className='text-black'>Office Address :</b> JIJAMATA CHOCK, H N. 2-10-1369, SAHYOG NAGAR, Beed, Beed, Maharashtra, 431122</p>
                            {/* <p className='mt-1 whitespace-nowrap'><b className='text-black'>Customer Care Number :</b> 011 45701990</p> */}

                            <p className='mt-1 whitespace-nowrap'><b className='text-black'>Contact Details :</b> +91 9022009765</p>
                            {/* <li className="mb-4">
                ...
                <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
                    <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2024 <a href="https://digiindiasolutions.com/">Seema Collections</a>. All Rights Reserved.
                    </span>

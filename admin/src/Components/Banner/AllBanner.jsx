    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "https://www.api.bkexporttradeco.store/api/get-Banners"
        );
...
useEffect(()=>{
  ...
  const makeActive = async (id) => {
    try {
      const res = await axios.put(`https://www.api.bkexporttradeco.store/api/Banner/active/${id}`);
  ...
  const makeInactive = async (id) => {
    try {
      const res = await axios.put(`https://www.api.bkexporttradeco.store/api/Banner/inactive/${id}`);
  ...
  const deleteBanner = async (id) => {
    try {
      const res = await axios.delete(`https://www.api.bkexporttradeco.store/api/delete-Banners/${id}`);
